 ...
 * @date 2014-9-10
 */
public class Eova_Button extends BaseModel<Eova_Button> {

	private static final long serialVersionUID = 3481288366186459644L;

	public static final Eova_Button dao = new Eova_Button();
	 ...
	 * @return
	 */
	public List<Eova_Button> queryByMenuCode(String menuCode, int rid) {
		return Eova_Button.dao.find("select * from eova_button where menuCode = ? and ui != '' and id in (select bid from eova_role_btn where rid = ?) order by indexNum", menuCode, rid);
	}
