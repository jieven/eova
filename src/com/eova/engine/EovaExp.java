...
//			System.out.println(str.trim());
	 ...
	 * @return
	 */
	public static Eova_Object getEo(String exp) {
...
//		eo.put("code", code);
	 ...
	 * @return
	 */
	public static List<Eova_Item> getEis(String exp) {
		...
		// Eova_Item ei = new Eova_Item();

		List<Eova_Item> eis = new ArrayList<Eova_Item>();
		int index = 0;
...
//			System.out.println("cn=" + cn);
	 ...
	 * @return
	 */
	public static Eova_Item buildItem(int index, String en, String cn, boolean isQuery) {
		Eova_Item ei = new Eova_Item();
