...
(function($) {
    ...
    function _42(_43, _44) {
        ...
        function _47(_48) {
            var _49 = _48 ? 1 : 2;
            var tr = _46.finder.getTr(_43, _44, "body", _49); (_48 ? dc.body1: dc.body2).children("table.datagrid-btable-frozen").append(tr);
        };
    };
    ...
    function _58(_59) {
        ...
        function _60() {
            ...
            for (var i = 0; i < _6f.length; i++) {
                var col = getColOptions(_59, _6f[i]);
                if (col && !col.checkbox) {
    ...
    function _72(_73) {
        ...
        _77.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
        function(e) {
        ...
        _78.unbind(".datagrid").bind("click.datagrid",
        function(e) {
    ...
    function _89(_8a, _8b) {
        ...
        for (var i = 0; i < _8f.length; i++) {
            var col = getColOptions(_8a, _8f[i]);
    ...
    function _97(_98) {
        ...
        for (var i = 0; i < _9e.length; i++) {
            var col = getColOptions(_98, _9e[i]);
            if (_9f(col)) {
                _9c += col.width;
                _9d = col;
            }
    ...
    function _54(_b5, _b6) {
        ...
        0);
        function fix(_bb) {
            var col = getColOptions(_b5, _bb);
            if (!col.checkbox) {
                _b7.ss.set("." + col.cellClass, col.boxWidth ? col.boxWidth + "px": "auto");
            }
        };
    };
    function fixCellWidth(_bc) {
        var dc = $.data(_bc, "datagrid").dc;
        dc.body1.add(dc.body2).find("td.datagrid-td-merged").each(function() {
            var td = $(this);
            var _bd = td.attr("colspan") || 1;
            var _be = getColOptions(_bc, td.attr("field")).width;
            for (var i = 1; i < _bd; i++) {
                td = td.next();
                _be += getColOptions(_bc, td.attr("field")).width + 1;
            }
    ...
    function resizeEditor(target) {
        ...
        dc.view.find("div.datagrid-editable").each(function() {
            ...
            var col = $(target).datagrid("getColumnOption", _c2);
    ...
    function stopEdit(_133, _134, _135) {
        ...
        if (!_135) {
            ...
            tr.find("div.datagrid-editable").each(function() {
                ...
                if(ed.type == 'eovacombo' || ed.type == 'eovafind'){
                	// 获取文本
	                var text = ed.actions.getText(ed.target);
	                // 如果文本有变更，更新文本
	                if (row[field] != text) {
	                    row[field] = text;
	                    changed = true;
            ...
            opts.onEndEdit.call(_133, _134, row, newValues);
        }
        tr.removeClass("datagrid-row-editing");
        _13c(_133, _134);
        $(_133).datagrid("refreshRow", _134);
        if (!_135) {
            opts.onAfterEdit.call(_133, _134, row, newValues);
        } else {
        ...
        tr.children("td").each(function() {
            ...
            if (col && col.editor) {
                ...
                if (tmpEditor) {
                    ...
                    var cellOutWidth = cell._outerWidth();
                    cell.addClass("datagrid-editable");
                    cell._outerWidth(cellOutWidth);
    ...
    function _16b(_16c) {
        ...
        function _174(ids, _175) {
            for (var i = 0; i < ids.length; i++) {
                ...
                if (_176 >= 0) { (_175 == "s" ? _100: _107)(_16c, _176, true);
                }
            }
        };
    ...
    function _95(_179, _17a) {
        ...
        0);
        function _17c() {
            var _17d = opts.loader.call(_179, _17b,
            function(data) {
                setTimeout(function() {
    ...
    var editorsObj = {
        ...
        checkbox: {
            ...
            setValue : function(jq, value) {
                ...
                $.fn.prop ? $(jq).prop("checked", checked) : $(jq).attr("checked", checked);
                // $(jq)._propAttr("checked", checked);
            }
        },
        numberbox: {
    ...
    $.fn.datagrid.methods = {
        ...
        getColumnOption: function(jq, _1d7) {
            return getColOptions(jq[0], _1d7);
        },
    ...
    $.fn.datagrid.parseOptions = function(_201) {
        var t = $(_201);
        return $.extend({},
        $.fn.panel.parseOptions(_201), $.parser.parseOptions(_201, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _204 = {
        ...
        renderRow: function(_214, _215, _216, index, row) {
            ...
            if (_216 && opts.rownumbers) {
                ...
                tbody.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">" + _219 + "</div></td>");
            }
            for (var i = 0; i < _215.length; i++) {
                var field = _215[i];
                var col = $(_214).datagrid("getColumnOption", field);
                if (col) {
                    var value = row[field];
                    ...
                    tbody.push("<td field=\"" + field + "\" " + cls + " " + _21e + ">");
                    var _21e = "";
                    if (!col.checkbox) {
                        if (col.align) {
                    ...
                    tbody.push("<div style=\"" + _21e + "\" ");
                    tbody.push(col.checkbox ? "class=\"datagrid-cell-check\"": "class=\"datagrid-cell " + col.cellClass + "\"");
                    tbody.push(">");
                    if (col.checkbox) {
                        tbody.push("<input type=\"checkbox\" " + (row.checked ? "checked=\"checked\"": ""));
                        tbody.push(" name=\"" + field + "\" value=\"" + (value != undefined ? value: "") + "\">");
                    } else {
                        if (col.formatter) {
                            tbody.push(col.formatter(value, row, index, field));
                        } else {
                            tbody.push(value);
                        }
                    }
