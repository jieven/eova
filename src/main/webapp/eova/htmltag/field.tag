...
<%} else if(item.type == "JSON框"){%>
	<div style="margin-left: 90px;"><#json id="${item.en}" name="${name}" value="${value!}" isNoN="${item.is_required!}" style="margin-top: 3px;width:99.9%;height:${item.height > 200 ? item.height : 200}px;" isReadonly="${readnoly!false}" /></div>
<%} else {// 默认为文本框%>
