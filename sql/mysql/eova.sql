...
CREATE TABLE `eova_button` (
  ...
  `menuCode` varchar(255) NOT NULL COMMENT '菜单Code',
  `name` varchar(255) NOT NULL COMMENT '按钮名称',
  `ui` varchar(255) DEFAULT '' COMMENT '按钮UI路径',
...
CREATE TABLE `eova_item` (
  ...
  `validator` varchar(255) DEFAULT '' COMMENT 'UI校验表达式',
...
CREATE TABLE `eova_object` (
  ...
  `viewName` varchar(255) DEFAULT '' COMMENT '查询数据视图',
  `tableName` varchar(50) DEFAULT '' COMMENT '保存数据主表',
