...
create sequence seq_eova_button increment by 1 start with 2521 maxvalue 9999999999;
create sequence seq_eova_dict increment by 1 start with 181 maxvalue 9999999999;
create sequence seq_eova_field increment by 1 start with 1731 maxvalue 9999999999;
create sequence seq_eova_log increment by 1 start with null1 maxvalue 9999999999;
create sequence seq_eova_menu increment by 1 start with 311 maxvalue 9999999999;
create sequence seq_eova_menu_object increment by 1 start with 201 maxvalue 9999999999;
create sequence seq_eova_object increment by 1 start with 181 maxvalue 9999999999;
create sequence seq_eova_role increment by 1 start with 81 maxvalue 9999999999;
create sequence seq_eova_role_btn increment by 1 start with 4911 maxvalue 9999999999;
create sequence seq_eova_user increment by 1 start with 51 maxvalue 9999999999;
...
comment on column eova_object.is_single is '是否单??;
