DROP SCHEMA IF EXISTS eova CASCADE;
DROP USER eova ;
CREATE USER eova WITH PASSWORD 'eova' NOSUPERUSER ;
CREATE SCHEMA IF NOT EXISTS AUTHORIZATION eova;
SET SEARCH_PATH TO 'eova';
-- ----------------------------
...
CREATE TABLE eova_button(
 id Integer NOT NULL,
 menuCode Character varying(255) DEFAULT '' NOT NULL,
 name Character varying(255) DEFAULT '' NOT NULL,
 ui Character varying(255) DEFAULT '' NOT NULL,
 bs Character varying(500) DEFAULT '',
 indexNum Integer DEFAULT '0'
)
WITH (OIDS=FALSE);
DROP SEQUENCE IF EXISTS eova_button_seq;
CREATE SEQUENCE eova_button_seq START WITH 100 INCREMENT BY 1;
ALTER TABLE eova_button ALTER id SET DEFAULT NEXTVAL('eova_button_seq');
...
WITH (OIDS=FALSE);
-- Add keys for table eova_dict
DROP SEQUENCE IF EXISTS eova_dict_seq;
CREATE SEQUENCE eova_dict_seq START WITH 17 INCREMENT BY 1;
ALTER TABLE eova_button ALTER id SET DEFAULT NEXTVAL('eova_button_seq');
...
CREATE TABLE eova_item(
 id Integer NOT NULL,
 objectCode Character varying(50) NOT NULL,
 poCode Character varying(255) DEFAULT '',
 en Character varying(30) NOT NULL,
 cn Character varying(30) DEFAULT '' NOT NULL,
 isAuto Boolean DEFAULT FALSE,
 dataType Character varying(20) DEFAULT 'string',
 type Character varying(10) DEFAULT '文本框',
 indexNum Integer DEFAULT '9',
 exp Character varying(800) DEFAULT '',
 isQuery Boolean DEFAULT FALSE,
 isShow Boolean DEFAULT TRUE,
 isOrder Boolean DEFAULT TRUE,
 isAdd Boolean DEFAULT TRUE,
 isUpdate Boolean DEFAULT TRUE,
 isEdit Boolean DEFAULT TRUE,
 isNotNull Boolean DEFAULT TRUE,
 placeholder Character varying(255) DEFAULT '',
 validate Character varying(255) DEFAULT '',
 valueExp Character varying(255) DEFAULT '',
...
;
COMMENT ON COLUMN eova_item.validate IS '校验表达式'
;
...
-- Add keys for table eova_item
DROP SEQUENCE IF EXISTS eova_item_seq;
CREATE SEQUENCE eova_item_seq START WITH 158 INCREMENT BY 1;
ALTER TABLE eova_item ALTER id SET DEFAULT NEXTVAL('eova_item_seq');
ALTER TABLE eova_item ADD CONSTRAINT PK_eova_item PRIMARY KEY (id)
;
...
INSERT INTO eova_item VALUES ('59', 'eova_menu_code', '', 'bizintegerercept', '自定义业务拦截器', '0', 'string', '文本域', '14', '', '0', '1', '1', '1', '1', '0', '0', '', '', '', '300', '0', '0');
...
CREATE TABLE eova_log(
 ...
 info Character varying(500) DEFAULT ''
)
WITH (OIDS=FALSE)
;
COMMENT ON COLUMN eova_log.uid IS '操作用户'
;
...
-- Add keys for table eova_log

ALTER TABLE eova_log ADD CONSTRAINT PK_eova_log PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_log_seq;
CREATE SEQUENCE eova_log_seq START WITH 25 INCREMENT BY 1;
ALTER TABLE eova_log ALTER id SET DEFAULT NEXTVAL('eova_log_seq');
...
CREATE TABLE eova_menu(
 ...
 type Character varying(20) DEFAULT '1' NOT NULL,
 icon Character varying(255) DEFAULT '',
 indexNum Integer DEFAULT '0',
 parentId Integer DEFAULT '0',
 isCollapse Boolean DEFAULT false,
 bizIntercept Character varying(255) DEFAULT '',
...
-- Add keys for table eova_menu

ALTER TABLE eova_menu ADD CONSTRAINT PK_eova_menu PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_menu_seq;
CREATE SEQUENCE eova_menu_seq START WITH 31 INCREMENT BY 1;
ALTER TABLE eova_menu ALTER id SET DEFAULT NEXTVAL('eova_menu_seq');
...
INSERT INTO eova_menu VALUES ('4', 'eova_menu', '菜单管理', 'singleGrid', 'icon-applicationsidetree', '1', '1', '0', 'com.eova.core.menu.Menuintegerercept', '');
INSERT INTO eova_menu VALUES ('5', 'eova_button', '按钮管理', 'singleGrid', 'icon-layout', '2', '1', '0', '', '');
INSERT INTO eova_menu VALUES ('6', 'eova_object', '对象管理', 'singleGrid', 'icon-databasetable', '3', '1', '0', 'com.eova.core.object.Objectintegerercept', '');
...
-- Add keys for table eova_menu_object

ALTER TABLE eova_menu_object ADD CONSTRAINT PK_eova_menu_object PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_menu_object_seq;
CREATE SEQUENCE eova_menu_object_seq START WITH 20 INCREMENT BY 1;
ALTER TABLE eova_menu_object ALTER id SET DEFAULT NEXTVAL('eova_menu_object_seq');
...
CREATE TABLE eova_object(
 ...
 name Character varying(50) NOT NULL,
 "view" Character varying(255) DEFAULT '',
 "table" Character varying(50) DEFAULT NULL,
 pkName Character varying(50) NOT NULL,
 dataSource Character varying(50) DEFAULT 'main',
 isSingleSelect Boolean DEFAULT TRUE,
 isCellEdit Boolean DEFAULT FALSE,
 isShowNum Boolean DEFAULT TRUE,
 isDefaultPkDesc Boolean DEFAULT TRUE,
 filterWhere Character varying(500) DEFAULT '',
 diyCard Character varying(255) DEFAULT '',
 diyList Character varying(255) DEFAULT '',
 diyIntercept Character varying(255) DEFAULT ''
)
WITH (OIDS=FALSE)
;
...
;
COMMENT ON COLUMN eova_object.view IS '查询数据视图'
;
COMMENT ON COLUMN eova_object.table IS '保存数据主表'
;
...
-- Add keys for table eova_object

ALTER TABLE eova_object ADD CONSTRAINT PK_eova_object PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_object_seq;
CREATE SEQUENCE eova_object_seq START WITH 20 INCREMENT BY 1;
ALTER TABLE eova_object ALTER id SET DEFAULT NEXTVAL('eova_object_seq');
-- ----------------------------
...
CREATE TABLE eova_role(
 ...
 fun Character varying(5000) DEFAULT ''
)
WITH (OIDS=FALSE)
;
...
-- Add keys for table eova_role

ALTER TABLE eova_role ADD CONSTRAINT PK_eova_role PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_role_seq;
CREATE SEQUENCE eova_role_seq START WITH 9 INCREMENT BY 1;
ALTER TABLE eova_role ALTER id SET DEFAULT NEXTVAL('eova_role_seq');
-- ----------------------------
...
-- Add keys for table eova_role_btn

ALTER TABLE eova_role_btn ADD CONSTRAINT PK_eova_role_btn PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_role_btn_seq;
CREATE SEQUENCE eova_role_btn_seq START WITH 1348 INCREMENT BY 1;
ALTER TABLE eova_role_btn ALTER id SET DEFAULT NEXTVAL('eova_role_btn_seq');
-- ----------------------------
...
CREATE TABLE eova_user(
 ...
 loginPwd Character varying(50) NOT NULL,
...
-- Add keys for table eova_user

ALTER TABLE eova_user ADD CONSTRAINT PK_eova_user PRIMARY KEY (id)
;
DROP SEQUENCE IF EXISTS eova_user_seq;
CREATE SEQUENCE eova_user_seq START WITH 20 INCREMENT BY 1;
ALTER TABLE eova_user ALTER id SET DEFAULT NEXTVAL('eova_user_seq');
-- ----------------------------
