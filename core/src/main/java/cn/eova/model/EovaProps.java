 ...
 * @author Jieven
 */
public class EovaProps extends BaseModel<EovaProps> {

    private static final long serialVersionUID = -1592533967096109392L;

    public static final EovaProps dao = new EovaProps().dao();
     ...
     * @return
     */
    public List<EovaProps> findTemplateByCode(String bizCode) {
