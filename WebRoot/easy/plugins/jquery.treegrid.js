...
(function($) {
    ...
    function _1f(_46, _47, _48, _49, _4a) {
        ...
        var _4f = _4b.loader.call(_46, _4d,
        function(_50) {
    ...
    function _72(_73, _74) {
        ...
        if (_76.length) {
            ...
            _1f(_73, row[_75.idField], _78, true,
            function() {
                if (cc.is(":empty")) {
                    _76.remove();
                } else {
        ...
        return this.each(function() {
            ...
            if (_a1) {
                ...
                _a1 = $.data(this, "treegrid", {
                    options: $.extend({},
                    $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _9e),
                    data: []
                });
            }
            _1(this);
    ...
    $.fn.treegrid.parseOptions = function(_b1) {
        return $.extend({},
        $.fn.datagrid.parseOptions(_b1), $.parser.parseOptions(_b1, ["treeField", {
            animate: "boolean"
        }]));
    };
    var _b2 = $.extend({},
    $.fn.datagrid.defaults.view, {
        ...
        renderRow: function(_cc, _cd, _ce, _cf, row) {
            ...
            for (var i = 0; i < _cd.length; i++) {
                var field = _cd[i];
                var col = $(_cc).datagrid("getColumnOption", field);
                if (col) {
                    ...
                    cc.push("<td field=\"" + field + "\" " + cls + " " + _d4 + ">");
                    var _d4 = "";
                    if (!col.checkbox) {
                        if (col.align) {
