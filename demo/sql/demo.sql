...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '详细地址' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (2, '张三1111', '上海陆家嘴333', '13524523888');
INSERT INTO `address` VALUES (3, '张三3', '上海陆家嘴', '13524523888');
INSERT INTO `address` VALUES (4, '张三4', '上海陆家嘴', '13524523888');
INSERT INTO `address` VALUES (5, '11', '1', '111');
...
CREATE TABLE `area`  (
  ...
  `lv` int NOT NULL COMMENT '级别：0=中国,1=省,2=市,3=区',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid_index`(`pid` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3412 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `area` VALUES (3409, '北平', 2, 1);
INSERT INTO `area` VALUES (3410, '紫禁城', 3409, 2);
...
CREATE TABLE `area_city`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '地区城市' ROW_FORMAT = Dynamic;
...
INSERT INTO `area_city` VALUES (25, '上海', '0');
...
-- ----------------------------
-- Table structure for data_10
-- ----------------------------
DROP TABLE IF EXISTS `data_10`;
CREATE TABLE `data_10`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `price` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic PARTITION BY HASH (`id`)
PARTITIONS 4
...
-- Records of data_10
-- ----------------------------
INSERT INTO `data_10` VALUES (1, 'aaa', 100);
INSERT INTO `data_10` VALUES (2, 'bbb', 200);
...
CREATE TABLE `data_login`  (
  ...
  `num` int NULL DEFAULT NULL COMMENT '每日活跃数',
  `num1` int NULL DEFAULT NULL COMMENT '每日登录数',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `data_login` VALUES (21, '2019-01-04', 1, 1);
...
CREATE TABLE `data_money`  (
  ...
  `num` int NULL DEFAULT NULL COMMENT '手机销售额',
  `num1` int NULL DEFAULT NULL COMMENT '电脑销售额',
  `num2` int NULL DEFAULT NULL COMMENT '套子销售额',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `dicts`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 368 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据字典' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dicts
-- ----------------------------
INSERT INTO `dicts` VALUES (1, '1', '被套', 'hotel_stock', 'category', NULL);
INSERT INTO `dicts` VALUES (2, '2', '床单', 'hotel_stock', 'category', '');
INSERT INTO `dicts` VALUES (3, '3', '浴巾', 'hotel_stock', 'category', '');
INSERT INTO `dicts` VALUES (4, '4', '毛巾', 'hotel_stock', 'category', '');
INSERT INTO `dicts` VALUES (5, '5', '枕套', 'hotel_stock', 'category', '');
...
INSERT INTO `dicts` VALUES (10, '1', '经济型酒店', 'hotel_bed', 'sizes', '');
INSERT INTO `dicts` VALUES (11, '2', '标准双人房', 'hotel_bed', 'sizes', '');
INSERT INTO `dicts` VALUES (12, '3', '	高端双人房', 'hotel_bed', 'sizes', '');
INSERT INTO `dicts` VALUES (13, '4', '水床套房', 'hotel_bed', 'sizes', '');
INSERT INTO `dicts` VALUES (54, '0', '坦克', 'users', 'tag', '');
INSERT INTO `dicts` VALUES (55, '1', 'ADC', 'users', 'tag', '');
INSERT INTO `dicts` VALUES (56, '2', 'MT', 'users', 'tag', '');
...
INSERT INTO `dicts` VALUES (224, '10', '待支付', 'orderss', 'state', '');
INSERT INTO `dicts` VALUES (225, '20', '已支付', 'orderss', 'state', '');
INSERT INTO `dicts` VALUES (226, '30', '已发货', 'orderss', 'state', '');
INSERT INTO `dicts` VALUES (227, '40', '已收货', 'orderss', 'state', '');
INSERT INTO `dicts` VALUES (228, '10', '待支付', 'v_orders', 'state', '');
INSERT INTO `dicts` VALUES (229, '20', '已支付', 'v_orders', 'state', '');
INSERT INTO `dicts` VALUES (230, '30', '已发货', 'v_orders', 'state', '');
INSERT INTO `dicts` VALUES (231, '40', '已收货', 'v_orders', 'state', '');
INSERT INTO `dicts` VALUES (234, '10', '待支付', 'orders', 'state', '');
INSERT INTO `dicts` VALUES (235, '20', '已支付', 'orders', 'state', '');
INSERT INTO `dicts` VALUES (236, '30', '已发货', 'orders', 'state', '');
INSERT INTO `dicts` VALUES (237, '40', '已收货', 'orders', 'state', '');
INSERT INTO `dicts` VALUES (238, '1', '事假', 'flow_appro', 'type', NULL);
INSERT INTO `dicts` VALUES (239, '2', '年假', 'flow_appro', 'type', NULL);
INSERT INTO `dicts` VALUES (240, '3', '病假', 'flow_appro', 'type', NULL);
INSERT INTO `dicts` VALUES (241, '4', '产假', 'flow_appro', 'type', NULL);
INSERT INTO `dicts` VALUES (246, '0', '普通', 'test_info', 'status', '');
INSERT INTO `dicts` VALUES (247, '1', '禁用', 'test_info', 'status', '');
INSERT INTO `dicts` VALUES (248, '11', '当日达', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (249, '12', '到货时效', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (250, '13', '线上发货不同步线下', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (251, '14', '强制验货拆分订单', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (252, '15', '天猫预售下沉', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (253, '16', '跨店满减', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (254, '21', '当日达', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (255, '22', '到货时效', 'test_info', 'tag', '');
INSERT INTO `dicts` VALUES (266, '0', '普通', 'test_info', 'status', '');
INSERT INTO `dicts` VALUES (267, '1', '禁用', 'test_info', 'status', '');
INSERT INTO `dicts` VALUES (268, '0', '准备上架', 'goods_style', 'status', '');
INSERT INTO `dicts` VALUES (269, '1', '已上架', 'goods_style', 'status', '');
INSERT INTO `dicts` VALUES (270, '2', '已下架', 'goods_style', 'status', '');
INSERT INTO `dicts` VALUES (277, '1', '租赁商品', 'product', 'type', '');
INSERT INTO `dicts` VALUES (278, '2', '积分商品', 'product', 'type', '');
INSERT INTO `dicts` VALUES (321, '1', '普通商户', 'hotel', 'state', '');
INSERT INTO `dicts` VALUES (322, '2', '签约商户', 'hotel', 'state', '');
INSERT INTO `dicts` VALUES (341, '0', '正常', 'users', 'status', '');
INSERT INTO `dicts` VALUES (342, '1', '禁用', 'users', 'status', '');
INSERT INTO `dicts` VALUES (343, '2', '注销', 'users', 'status', '');
INSERT INTO `dicts` VALUES (346, '0', '中国', 'area', 'lv', '');
INSERT INTO `dicts` VALUES (347, '1', '省', 'area', 'lv', '');
INSERT INTO `dicts` VALUES (348, '2', '市', 'area', 'lv', '');
INSERT INTO `dicts` VALUES (349, '3', '区', 'area', 'lv', '');
INSERT INTO `dicts` VALUES (366, '1', '正常', 'links', 'status', '');
INSERT INTO `dicts` VALUES (367, '2', '禁用', 'links', 'status', '');
...
-- ----------------------------
INSERT INTO `goods_cat` VALUES (1, '女装', 0, 1);
INSERT INTO `goods_cat` VALUES (2, '男装', 0, 0);
INSERT INTO `goods_cat` VALUES (3, '童装', 0, 1);
INSERT INTO `goods_cat` VALUES (4, '职业装', 1, 1);
INSERT INTO `goods_cat` VALUES (5, '连衣裙', 1, 1);
INSERT INTO `goods_cat` VALUES (6, '西装', 1, 1);
INSERT INTO `goods_cat` VALUES (7, '西装', 2, 1);
INSERT INTO `goods_cat` VALUES (8, '母婴', 0, 0);
INSERT INTO `goods_cat` VALUES (9, '美妆', 0, 1);
...
CREATE TABLE `goods_style`  (
  ...
  `status` tinyint NULL DEFAULT 0 COMMENT '上架状态:0=准备上架,1=已上架,2=已下架',
  `code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '款号',
  `tag` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签',
  `price` double(10, 2) NOT NULL DEFAULT 0.00 COMMENT '默认价格',
  `cid2` int NULL DEFAULT NULL COMMENT '上级类目',
  `cid` int NULL DEFAULT NULL COMMENT '类目(旧)',
  `cat_id` int NULL DEFAULT NULL COMMENT '类目',
  `cat_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '类目名称',
  `colors` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支持颜色',
  `sizes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支持尺码',
  `product_id` int NULL DEFAULT NULL COMMENT '产品',
  `create_uid` int NOT NULL DEFAULT 0 COMMENT '创建人ID',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `location` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '库位',
  `fabric_id` int NULL DEFAULT NULL COMMENT '面料',
  `tag_id` int NULL DEFAULT NULL COMMENT '吊牌',
  `label_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签',
  `unit` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `i_supplier_id`(`supplier_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '款式' ROW_FORMAT = Dynamic;
...
CREATE TABLE `hotel`  (
  ...
  `state` int NULL DEFAULT 1 COMMENT '用户状态：1=普通商户，2=签约商户',
  `score` int NULL DEFAULT 0 COMMENT '积分',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `province` int NULL DEFAULT NULL COMMENT '省',
  `city` int NULL DEFAULT NULL COMMENT '市',
  `region` int NULL DEFAULT NULL COMMENT '区',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '酒店' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hotel
-- ----------------------------
INSERT INTO `hotel` VALUES (1, '松江锦江之星3', '(021)37621128', '上海市松江区西林北路950号1111112', 2, 12, '2015-12-04 00:00:00', NULL, NULL, NULL);
INSERT INTO `hotel` VALUES (2, '松江锦江之星2', '(021)37621129', '上海市松江区西林北路951号', 1, 0, '2015-09-04 17:17:00', 2, 52, 505);
INSERT INTO `hotel` VALUES (3, '松江锦江之星1', '(021)37621130', '上海市松江区西林北路952号', 2, 0, '2015-09-05 17:17:00', 3, 36, 398);
INSERT INTO `hotel` VALUES (5, '阳光酒店', '13566669999', '001', 1, 0, '2019-02-16 18:35:09', 2, 52, 500);
INSERT INTO `hotel` VALUES (6, '阳光酒店', '13566669999', '001', 1, 0, '2019-02-16 18:35:22', 2, 52, 500);
INSERT INTO `hotel` VALUES (9, '艳阳天', '13566669999', '001', 1, 0, '2019-02-17 00:48:57', 2, 52, 500);
...
CREATE TABLE `hotel_bed`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `hotel_id` int NOT NULL COMMENT '酒店',
  `sizes` int NOT NULL COMMENT '床铺尺码',
...
-- ----------------------------
INSERT INTO `hotel_bed` VALUES (4, 1, 1, 10);
INSERT INTO `hotel_bed` VALUES (8, 1, 2, 20);
INSERT INTO `hotel_bed` VALUES (9, 1, 3, 30);
INSERT INTO `hotel_bed` VALUES (10, 1, 4, 40);
INSERT INTO `hotel_bed` VALUES (11, 2, 1, 50);
INSERT INTO `hotel_bed` VALUES (12, 2, 2, 60);
INSERT INTO `hotel_bed` VALUES (13, 2, 3, 70);
INSERT INTO `hotel_bed` VALUES (14, 2, 4, 80);
INSERT INTO `hotel_bed` VALUES (15, 3, 1, 90);
INSERT INTO `hotel_bed` VALUES (16, 3, 2, 100);
INSERT INTO `hotel_bed` VALUES (17, 3, 3, 110);
INSERT INTO `hotel_bed` VALUES (18, 3, 4, 120);
INSERT INTO `hotel_bed` VALUES (19, 4, 1, 130);
INSERT INTO `hotel_bed` VALUES (20, 4, 2, 140);
INSERT INTO `hotel_bed` VALUES (21, 4, 3, 150);
INSERT INTO `hotel_bed` VALUES (22, 4, 4, 160);
INSERT INTO `hotel_bed` VALUES (23, 5, 1, 170);
INSERT INTO `hotel_bed` VALUES (24, 5, 2, 180);
INSERT INTO `hotel_bed` VALUES (25, 5, 3, 190);
INSERT INTO `hotel_bed` VALUES (26, 5, 4, 200);
...
CREATE TABLE `hotel_stock`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `hotel_id` int NOT NULL COMMENT '酒店',
  `category` int NOT NULL COMMENT '商品类型',
  `num` int NULL DEFAULT 1 COMMENT '存货量',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `hotel_stock` VALUES (1, 1, 2, 4);
INSERT INTO `hotel_stock` VALUES (2, 1, 2, 11);
INSERT INTO `hotel_stock` VALUES (6, 1, 1, 100);
INSERT INTO `hotel_stock` VALUES (7, 2, 1, 10);
INSERT INTO `hotel_stock` VALUES (8, 2, 1, 10);
INSERT INTO `hotel_stock` VALUES (9, 2, 4, 20);
INSERT INTO `hotel_stock` VALUES (10, 2, 1, 2);
INSERT INTO `hotel_stock` VALUES (11, 2, 2, 5);
INSERT INTO `hotel_stock` VALUES (12, 3, 2, 1);
INSERT INTO `hotel_stock` VALUES (13, 3, 4, 1);
INSERT INTO `hotel_stock` VALUES (14, 3, 2, 1);
INSERT INTO `hotel_stock` VALUES (15, 3, 5, 1);
...
-- Records of links
-- ----------------------------
INSERT INTO `links` VALUES (2, 2, '最简单的低代码开发平台', 'https://www.eova.cn', '林羽', 'test', 1);
INSERT INTO `links` VALUES (13, 1, '2', 'http://www..com', '3', '3', 0);
INSERT INTO `links` VALUES (16, 1, '1', 'http://www..com', '1', '1', 0);
INSERT INTO `links` VALUES (24, 1, '11', 'http://www..com', '2', '3', 0);
INSERT INTO `links` VALUES (25, 1, '2', 'http://www..com', NULL, NULL, 0);
INSERT INTO `links` VALUES (26, 1, '222', 'http://www..com', NULL, NULL, 0);
INSERT INTO `links` VALUES (27, 1, '2312', 'http://www..com', NULL, NULL, 0);
INSERT INTO `links` VALUES (28, 1, '23442', 'http://www..com', NULL, NULL, 0);
INSERT INTO `links` VALUES (29, 1, '22', 'http://www..com', '3443', '43655', 0);
INSERT INTO `links` VALUES (30, 1, '1232', 'http://www..com', '32', '432432', 0);
INSERT INTO `links` VALUES (31, 1, '1111', 'http://www..com', '2321', '321312', 0);
INSERT INTO `links` VALUES (32, 1, '324234', 'http://www..com', '3432', '4112312', 0);
INSERT INTO `links` VALUES (33, 1, '423', 'http://www..com', '34', '23432432', 0);
INSERT INTO `links` VALUES (34, 1, '432432', 'http://www..com', '432', '43243223', 0);
INSERT INTO `links` VALUES (35, 1, '3423', 'http://www..com', '432432', '432432', 0);
INSERT INTO `links` VALUES (36, 1, '3523', 'http://www..com', '3213', '321321', 0);
INSERT INTO `links` VALUES (37, 1, '3213', 'http://www..com', '321', '321312', 0);
INSERT INTO `links` VALUES (38, 1, '43324', 'http://www..com', '324', '32432432', 0);
INSERT INTO `links` VALUES (39, 1, '43324', 'http://www..com', '324', '32432432', 0);
INSERT INTO `links` VALUES (40, 1, '321321', 'https://www..com', '3213', '321321', 0);
INSERT INTO `links` VALUES (41, 1, '最简单的MVC', 'https://www.jfinal.com', '波哥最帅', 'test', 0);
INSERT INTO `links` VALUES (42, 1, '22223333', 'http://www.eova.com', 'aaaa', 'bbbbb', 0);
INSERT INTO `links` VALUES (43, 1, '3213213', 'https://www.1111.com', '3213', '21321', 0);
...
CREATE TABLE `my_file`  (
  ...
  `files` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '文件',
  `imgs` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '图片',
...
-- Records of my_file
-- ----------------------------
INSERT INTO `my_file` VALUES (1, 0, '1621667343201@23826610.pdf,1621670548621@49535699.pdf', '162166740478598353.png', NULL);
INSERT INTO `my_file` VALUES (2, 0, NULL, '162519318317812288.png', NULL);
INSERT INTO `my_file` VALUES (3, 0, NULL, '162502165269703338.jpeg', NULL);
INSERT INTO `my_file` VALUES (4, 0, NULL, '162459111512342164.jfif', NULL);
INSERT INTO `my_file` VALUES (5, 0, NULL, '162519318317812288.png', NULL);
INSERT INTO `my_file` VALUES (6, 0, '5a5ec53376400.jpg', '165579766347795169.jpg', NULL);
...
CREATE TABLE `orders`  (
  ...
  `hotel_id` int NULL DEFAULT 0 COMMENT '所属酒店',
  `pay_id` int NULL DEFAULT 0 COMMENT '支付ID',
  `state` int UNSIGNED NULL DEFAULT 10 COMMENT '订单状态：10=待支付,20=已支付,30=已发货,40=已收货',
  ...
  `update_user_id` int NOT NULL COMMENT '最后更新用户ID',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `is_invoice` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '是否开票',
...
INSERT INTO `orders` VALUES (2, 1, 2, 10, 6.00, 0.00, '222', 21, 21, '2015-11-06 23:49:02', '2015-11-06 23:49:02', 0, NULL, 'gongyi', 'gongyi', 'gongyi', 2);
...
INSERT INTO `orders` VALUES (13, 0, 0, 10, 0.00, 0.00, '11', 24, 24, '2018-07-09 17:16:37', '2018-07-09 17:16:37', 0, NULL, NULL, NULL, NULL, 5);
...
CREATE TABLE `orderss`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '编号',
  `pay_id` int NULL DEFAULT 0 COMMENT '支付ID',
  `state` int UNSIGNED NULL DEFAULT 10 COMMENT '订单状态：10=待支付,20=已支付,30=已发货,40=已收货：支付过程的状态标识',
  `money` double(10, 2) UNSIGNED NULL DEFAULT 0.00 COMMENT '应付金额',
  `memo` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
...
-- Records of orderss
-- ----------------------------
INSERT INTO `orderss` VALUES (1, 0, 20, 0.00, '3443243243234432', '2018-07-14 16:41:35', '2018-07-14 16:41:37');
INSERT INTO `orderss` VALUES (2, 0, 40, 0.00, NULL, '2018-07-14 19:39:24', '2018-07-14 19:39:32');
...
CREATE TABLE `product`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `type` int NULL DEFAULT 1 COMMENT '产品类型：1=租赁商品，2=积分商品',
  `category` int NOT NULL COMMENT '分类',
  `stuff` int NOT NULL COMMENT '材料',
  `sizes` int NOT NULL COMMENT '尺码',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  ...
  `cost_score` int NULL DEFAULT 0 COMMENT '消耗积分：购买商品需消耗的积分',
  `score` int NULL DEFAULT 0 COMMENT '奖励积分',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (28, 1, 5, 1, 3, '150床型纯棉被套222', '159964520725056877.png,159964520724981910.png', 3, 2.4, 0, 676, 0, '2023-08-16 00:00:00', '2025-07-01 16:29:18');
INSERT INTO `product` VALUES (29, 1, 5, 1, 3, '150床型纯棉被套6666', '175863709904758315.png', 3, 2.4, 0, 5, 5000, '2015-11-06 00:00:00', '2025-10-13 16:18:40');
INSERT INTO `product` VALUES (30, 1, 5, 1, 1, '纯棉枕套11111', '175863709904758315.png', 3, 2.4, 3, 10, 0, '2015-11-06 00:00:00', '2025-10-13 16:18:41');
INSERT INTO `product` VALUES (31, 2, 4, 1, 1, '4332432', '175863709904758315.png', 1, 2, 3, 11, 6, '2019-06-14 00:00:00', '2025-10-13 16:18:43');
INSERT INTO `product` VALUES (32, 2, 3, 2, 1, '3432', '175863709904758315.png', 0, 0, 20, 12, 1, '2019-06-14 00:00:00', '2025-10-13 16:18:43');
INSERT INTO `product` VALUES (33, 1, 2, 2, 2, '3333', '175863709904758315.png', 1111, 0, 0, 35, 1, '2020-08-03 00:00:00', '2025-10-13 16:18:43');
INSERT INTO `product` VALUES (34, 1, 1, 1, 2, '11111', '175863709904758315.png', 0, 0, 0, 58, 1, '2020-08-03 00:00:00', '2025-10-13 16:18:44');
INSERT INTO `product` VALUES (35, 1, 4, 1, 1, '3232321', '175863709904758315.png', 1, 1, 1, 75, 1, '2020-09-09 00:00:00', '2025-10-13 16:18:45');
INSERT INTO `product` VALUES (36, 1, 3, 1, 2, '3432423432', NULL, 0, 0, 0, 10, 1, '2021-12-14 00:00:00', '2025-07-01 16:29:07');
INSERT INTO `product` VALUES (37, 1, 2, 1, 1, '我Mysql8.0', '175863709904758315.png', 1, 1, 1, 20, 1, '2023-08-16 00:00:00', '2025-10-13 16:18:46');
INSERT INTO `product` VALUES (38, 1, 1, 1, 2, '11', NULL, 1, 1, 1, 30, 1, '2024-06-12 00:00:00', '2025-07-01 16:29:06');
INSERT INTO `product` VALUES (39, 1, 4, 11, 7, '1122', NULL, 0, 0, 0, 40, 1, '2025-01-15 00:00:00', '2025-07-01 16:29:06');
INSERT INTO `product` VALUES (40, 1, 3, 1, 37, '新增测试1', '176295681133625868.png,176296654429474664.png', 0, 0, 0, 50, 1, '2025-01-15 00:00:00', '2025-07-01 16:29:06');
INSERT INTO `product` VALUES (42, 1, 2, 2, 2, '2', '175863709904758315.png', 0, 0, 0, 60, 1, '2025-01-15 00:00:00', '2025-10-13 16:18:47');
INSERT INTO `product` VALUES (43, 1, 2, 3, 9, 'eova-icon-theme1', NULL, 0, 0, 0, 0, 1101, '2025-01-15 00:00:00', '2025-07-01 16:29:05');
INSERT INTO `product` VALUES (51, 1, 1, 1, 38, '1', '176295730811149398.png', 0, 0, 0, 0, 1, '2025-01-15 03:21:42', '2025-01-15 03:21:42');
INSERT INTO `product` VALUES (52, 1, 1, 1, 38, '1', '176297081794308482.png', 0, 0, 0, 0, 1, '2025-01-15 03:21:42', '2025-11-13 02:01:45');
...
-- ----------------------------
INSERT INTO `sale_data` VALUES (1, 25, '比亚迪宋', 10.001);
...
INSERT INTO `sale_data` VALUES (44, 4, '酷派', 48);
INSERT INTO `sale_data` VALUES (45, 4, '黑莓', 49);
INSERT INTO `sale_data` VALUES (46, 4, '酷派', 48);
INSERT INTO `sale_data` VALUES (47, 4, '黑莓', 49);
INSERT INTO `sale_data` VALUES (48, 4, '火腿', 1000);
INSERT INTO `sale_data` VALUES (49, 4, '酷派', 48);
INSERT INTO `sale_data` VALUES (50, 4, '黑莓', 49);
INSERT INTO `sale_data` VALUES (51, 4, '火腿', 1000);
INSERT INTO `sale_data` VALUES (52, 4, '酷派', 48);
INSERT INTO `sale_data` VALUES (53, 4, '黑莓', 49);
INSERT INTO `sale_data` VALUES (54, 4, '火腿', 1000);
INSERT INTO `sale_data` VALUES (55, 4, '酷派', 48);
INSERT INTO `sale_data` VALUES (56, 4, '黑莓', 49);
INSERT INTO `sale_data` VALUES (57, 4, '火腿', 1000);
...
CREATE TABLE `test_info`  (
  ...
  `status` int NULL DEFAULT 0 COMMENT '状态：0=普通，1=禁用',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  ...
  `test1` int UNSIGNED NULL DEFAULT NULL,
  `test2` float(3, 1) NULL DEFAULT NULL,
  `test3` double(10, 2) NULL DEFAULT NULL,
  `test4` tinyint(1) NULL DEFAULT NULL,
  `test5` bigint UNSIGNED NULL DEFAULT NULL,
  `test6` tinyint UNSIGNED NULL DEFAULT NULL,
  `test7` datetime NULL DEFAULT NULL COMMENT 'datetime',
  `test8` decimal(10, 0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `test_info` VALUES (4, 2, 0, 'Eova', 20, '<p>哎哟不错哟！ 发个表情试试&nbsp;<img src=\"http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/lovea_thumb.gif\"><br></p><p><img src=\"data:image/png;base64,\" alt=\"\"><br></p><img src=\"http://pro.dev.eova.cn/editor/2020/160277104957378066.png\" style=\"max-width:100%;\"><p><br></p>', NULL, 1, '423432423', NULL, '2024-04-01', '2024-04-01 11:41:03', '000000', '#000000', '3', NULL, 0, 20.2, 40.22, NULL, 0, NULL, NULL, NULL);
INSERT INTO `test_info` VALUES (7, 1, 1, '新增导入1', 17, '<p>222上海虹口区足球场上海虹口222</p><p><br></p>', '159542139248361825.png,159542139868586340.png', 0, '更新导入。。。。', NULL, NULL, '2020-07-22 20:36:39', '00000', '#000000', '2,4', NULL, 0, 30.3, 50.33, NULL, 0, NULL, NULL, NULL);
INSERT INTO `test_info` VALUES (8, 2, 1, '新增导入2', 30, '<p>哎哟不错哟！ 发个表情试试 <img src=\"http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/lovea_thumb.gif\"><br></p><p><img src=\"data:image/png;base64,\" alt=\"\"><br></p>', '159542439312600891.png,159542751682208407.png', NULL, '6666', NULL, NULL, '2020-07-22 22:18:47', '000000', '#000000', '3', NULL, 0, 40.4, 60.44, NULL, 0, NULL, NULL, NULL);
INSERT INTO `test_info` VALUES (9, 2, 0, '卡卡西', 50, '<p>423</p>', '159542436394854101.png,159542436394820401.png', 1, '4322344', NULL, NULL, '2020-07-22 21:26:05', '423', '#000000', '2', NULL, 1, 50.0, 70.00, 1, 1, 1, NULL, NULL);
INSERT INTO `test_info` VALUES (10, 3, 0, '3432432', 11, '<p>11111111</p>', NULL, 1, NULL, NULL, NULL, '2023-08-11 10:17:55', NULL, '#000000', '1,2', NULL, NULL, NULL, NULL, 1, 1, 1, '2023-08-11 10:18:10', NULL);
INSERT INTO `test_info` VALUES (11, 1, 0, '111', 11, '<p>22</p>', NULL, 1, '111', NULL, '2024-04-03', '2024-04-03 00:57:57', '222', '#000000', NULL, NULL, 1, 1.0, NULL, 1, 1, 1, '2024-04-03 00:58:12', NULL);
...
CREATE TABLE `user_info`  (
  `id` int NOT NULL,
  `rid` int NULL DEFAULT 0 COMMENT '冗余角色ID',
  `status` int NULL DEFAULT 0 COMMENT '状态',
...
CREATE TABLE `users`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `status` int NULL DEFAULT 0 COMMENT '状态:0=正常,1=禁用,2=注销',
  ...
  `nickname1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '昵称',
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (7, 1, 'test11111', '000011', '德玛西亚之力2', '', '2019-09-20 15:31:19', '这个用户是专业差评11', '1');
INSERT INTO `users` VALUES (9, 1, '11111111111', '000000', '卡牌大师', '', '2019-09-20 10:50:57', '12', '0');
INSERT INTO `users` VALUES (10, 0, 'test9', '000000', '冯提莫', '', '2014-12-30 00:55:49', '6666', '0');
INSERT INTO `users` VALUES (12, 0, 'test12', '000000', '熔岩巨兽', '', '2019-09-20 15:34:54', '11', '1');
...
INSERT INTO `users` VALUES (21, 0, 'test21', '000000', '风暴之怒', '', '2014-12-30 00:00:00', '4444', '3');
INSERT INTO `users` VALUES (22, 0, 'test1111', '000000', '麦林雷', '', '2014-12-05 00:00:00', '213423423', '1');
INSERT INTO `users` VALUES (23, 1, 'test1111222', '000011', '德玛西亚之力', '', '2017-10-14 13:08:04', '这个用户是专业差评11', '11111');
INSERT INTO `users` VALUES (24, 1, 'test22', '000000', '卡牌大师', '', '2014-12-30 00:55:49', '12', '0');
INSERT INTO `users` VALUES (25, 0, '22222222', '000000', '堕落天使', '', '2014-12-30 00:55:49', '', '');
INSERT INTO `users` VALUES (26, 0, 'test121116', '000000', '熔岩巨兽', '', '2014-12-30 00:55:49', '11', '1');
INSERT INTO `users` VALUES (27, 0, 'test131111', '000000', '祖安狂人', '', '2014-12-30 00:55:49', '', '');
INSERT INTO `users` VALUES (28, 0, '666666', '000000', '钢铁大使111', '', '2014-12-30 00:55:49', '', '');
INSERT INTO `users` VALUES (29, 0, 'test15', '000000', '寡妇制造者', '', '2014-12-30 00:55:49', '1111', '3,2');
INSERT INTO `users` VALUES (30, 0, 'test16', '000000', '时光守护者', '', '2014-12-30 00:55:49', '', '3');
INSERT INTO `users` VALUES (31, 0, 'test17', '000000', '末日使者', '', '2014-12-30 00:55:49', '', '2,3');
INSERT INTO `users` VALUES (32, 0, 'test18', '000000', '殇之木乃伊', '', '2014-12-30 00:55:49', '', '0,3');
INSERT INTO `users` VALUES (33, 0, 'test19', '000000', '牛头酋长', '', '2014-12-30 00:55:49', '', '0');
INSERT INTO `users` VALUES (34, 0, 'test20', '000000', '邪恶小法师', '', '2014-12-30 00:55:49', '', '3');
INSERT INTO `users` VALUES (35, 0, 'test21', '000000', '风暴之怒', '', '2014-12-30 00:00:00', '4444', '3');
INSERT INTO `users` VALUES (37, 1, 'test1111222', '000011', '德玛西亚', '', '2017-10-14 00:00:00', '这个用户是专业差评11', '1');
INSERT INTO `users` VALUES (38, 1, 'test22', '000000', '卡牌大师', '', '2014-12-30 00:00:00', '12', '0,1,2');
INSERT INTO `users` VALUES (39, 0, 'test10', '000000', '堕落天使', '', '2014-12-30 00:55:49', '', '');
INSERT INTO `users` VALUES (40, 0, 'test12', '000000', '熔岩巨兽', '', '2014-12-30 00:55:49', '11', '1');
INSERT INTO `users` VALUES (41, 0, 'test13', '000000', '祖安狂人', '', '2014-12-30 00:55:49', '', '');
INSERT INTO `users` VALUES (42, 0, 'test14', '000000', '钢铁大使', '', '2014-12-30 00:55:49', '#000000', '1');
INSERT INTO `users` VALUES (82, 0, 'test001', '000000', '测试用户', '', '2025-10-18 15:02:09', '', '');
...
CREATE TABLE `users_exp`  (
  ...
  `avg` int NULL DEFAULT 0 COMMENT '年龄',
...
CREATE TABLE `users_item`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `users_id` int NOT NULL COMMENT '艺人',
  `item_id` int NOT NULL COMMENT '道具',
  PRIMARY KEY (`id`) USING BTREE
